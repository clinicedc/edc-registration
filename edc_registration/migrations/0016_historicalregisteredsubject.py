    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('identity_or_pk', models.CharField(db_index=True, default=edc_base.utils.get_uuid, editable=False, max_length=75, verbose_name='identity or pk')),
                ('identity_type', edc_model_fields.fields.identity_type_field.IdentityTypeField(blank=True, choices=[('OMANG', 'Omang'), ('DRIVERS', "Driver's License"), ('PASSPORT', 'Passport'), ('OMANG_RCPT', 'Omang Receipt'), ('OTHER', 'Other')], max_length=15, null=True, verbose_name='What type of identity number is this?')),
